...
class search extends mainacc
{
    ...
    function sqlcmd()
    {
        ...
        $this->sqlcmd = 'select mainlist.indexkey AS mindexkey,mainlist.indate,pmodel.item,pmodel.jan AS jan,mainlist.modexsn,mainlist.comment,user.item AS user,category.item1 AS category  from mainlist 
